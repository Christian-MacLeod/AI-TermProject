...
class Controller:
    ...
    def memorizeAround(self, pos):
        ...
        for i in range(-10, 10):
            for j in range(-10, 10):
                ...
                x_bounded = self.body.env.x_lower <= x_test <= self.body.env.x_upper
                y_bounded = self.body.env.y_lower <= y_test <= self.body.env.y_upper
    ...
    def prepareEvadeAgents(self, dodge):
        ...
        # Move away from center of mass with random jitter
